...
export function Reader__ReadArray_412036CA(x, len, t) {
    if (isRecord(t)) {
        ...
        return makeUnion(case$, (fieldTypes.length === 1) ? [Reader__Read_24524716(x, fieldTypes[0])] : ((fieldTypes.length === 0) ? [] : ((void Reader__ReadByte(x), map((arg) => Reader__Read_24524716(x, arg), fieldTypes)))), true);
    }
        ...
        return makeTuple(map((arg_2) => Reader__Read_24524716(x, arg_2), getTupleElements(t)), t);
    }
